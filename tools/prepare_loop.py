...
def main() -> int:
    ...
    graph = (
        ...
        f"[tail]afade=t=out:st=0:d={fade}:curve=qsin[tail_fade];"
        f"[head]afade=t=in:st=0:d={fade}:curve=qsin[head_fade];"
        "[tail_fade][head_fade]amix=inputs=2:duration=longest:normalize=0[seam];"
